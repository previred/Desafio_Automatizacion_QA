...
@CucumberOptions(features = "src/test/java/testfeatures/Flujo/CP_FlujoMonitor.feature", glue = {"code/Flujo/CompraMonitor"},
        tags = {"@FlujoCompraMonitor"},
        plugin = {"com.cucumber.listener.ExtentCucumberFormatter:", "json:output/cucumber-reports-jenkins/Cucumber.json"})
public class RunnerCompraMonitor {
    ...
    public static void setuppre() {
        ...
        extentProperties.setReportPath("output/cucumber-extent/Test_Previred_CompraMonitor.html");//" + dateG + "
    }
